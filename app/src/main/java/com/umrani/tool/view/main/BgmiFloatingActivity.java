...
public class BgmiFloatingActivity extends Service {
       ...
       /* view = LayoutInflater.from(this).inflate(R.layout.layout_aimbot, null);
        ...
        frameLayout.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (n == 0) {
                    this.deltaX = (float)BgmiFloatingActivity.this.g_layoutParams.x - motionEvent.getRawX();
                    this.deltaY = (float)BgmiFloatingActivity.this.g_layoutParams.y - motionEvent.getRawY();
                    this.pressedX = motionEvent.getRawX();
                    this.pressedY = motionEvent.getRawY();
                    BgmiFloatingActivity.this.scrollView.requestDisallowInterceptTouchEvent(true);
                    return false;
                }
                if (n == 1) {
                    float f;
                    ...
                    float f3;
                    float f4;
                    this.maxX = BgmiFloatingActivity.this.width - BgmiFloatingActivity.this.relativeLayout.getWidth();
                    this.maxY = BgmiFloatingActivity.this.height - BgmiFloatingActivity.this.relativeLayout.getHeight();
                    if (this.newX < 0.0f) {
                        this.newX = 0.0f;
                    }
                    ...
                    BgmiFloatingActivity.this.g_layoutParams.x = (int)this.newX;
                    BgmiFloatingActivity.this.g_layoutParams.y = (int)this.newY;
                    BgmiFloatingActivity.this.windowManager.updateViewLayout((View) BgmiFloatingActivity.this.relativeLayout, (ViewGroup.LayoutParams) BgmiFloatingActivity.this.g_layoutParams);
                    //FloatingModMenuService.this.relativeLayout.setAlpha(0.7f);
                    BgmiFloatingActivity.this.scrollView.requestDisallowInterceptTouchEvent(false);
                    return true;
                }
                if (n == 2) {
                    float f;
                    ...
                    this.maxX =  BgmiFloatingActivity.this.width -  BgmiFloatingActivity.this.relativeLayout.getWidth();
                    this.maxY = f5 = (float)( BgmiFloatingActivity.this.height -  BgmiFloatingActivity.this.relativeLayout.getHeight());
                    float f6 = this.newX;
        ...
        relativeLayout.setOnTouchListener(new View.OnTouchListener(){
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (n == 1) {
                    ...
                    if (n2 == 0 && n3 == 0) {
                        BgmiFloatingActivity.this.relativeLayout.setVisibility(0);
                ...
                if (n == 2) {
                    this.newX = motionEvent.getRawX() + this.deltaX;
                    this.newY = motionEvent.getRawY() + this.deltaY;
                    float f =  BgmiFloatingActivity.this.width - view.getWidth();
                    float f2 = BgmiFloatingActivity.this.height - view.getHeight();
                    if (this.newX < 0.0f) {
                        this.newX = 0.0f;
                    }
                    if (this.newX > f) {
                    ...
                    BgmiFloatingActivity.this.windowManager.updateViewLayout((View)relativeLayout, (ViewGroup.LayoutParams)layoutParams4);
                }
                return false;
            }
        });
        button.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                BgmiFloatingActivity.this.relativeLayout.setVisibility(8);
                relativeLayout.setVisibility(0);
            }
        });

        this.AddTextRED("PUBG BGMI");
        this.AddText("");
        ...
        AddButtonClose("CLOSE FLOATING MENU", new View.OnClickListener(){
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder((Context)BgmiFloatingActivity.this, 5);
 ...
 /*   private void layoutParams() {
    ...
    public void ExecZLX(String path, String toastHZ) {
        try {
            ...
            Toast.makeText(BgmiFloatingActivity.this, toastHZ, Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
        }
    }

...
public class Trickshot extends View {
    ...
    private void init() {
        ...
        circleOne.setColor(getContext().getColor(R.color.accent_red));
        circleOne.setAntiAlias(true);

        circleOneMiddle.setStyle(Paint.Style.FILL);
        circleOneMiddle.setColor(getContext().getColor(R.color.accent_red));
        circleOneMiddle.setAntiAlias(true);

        circleOneMiddleBorder.setStyle(Paint.Style.FILL);
        circleOneMiddleBorder.setColor(getContext().getColor(R.color.accent_red));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(xCircleOne, yCircleOne, 14, circleOneMiddle);

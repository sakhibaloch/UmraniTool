...
import com.umrani.tool.core.system.BProcessManagerService;
import com.umrani.tool.core.system.ISystemService;
import com.umrani.tool.core.system.ProcessRecord;
...
import com.umrani.tool.entity.pm.InstalledPackage;
import com.umrani.tool.utils.AbiUtils;
import com.umrani.tool.utils.FileUtils;
import com.umrani.tool.utils.Slog;
import com.umrani.tool.utils.compat.PackageParserCompat;
        ...
        try {
            ...
            if (!support) {
                ...
                return result.installError(packageArchiveInfo.packageName,
                        msg + (BlackBoxCore.is64Bit() ? " not support armeabi-v7a abi" : "not support armeabi-v7a abi"));
            }

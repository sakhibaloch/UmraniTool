...
Java_com_umrani_tool_view_main_LoginActivity_Check(JNIEnv *env, jclass clazz) {
    // TODO: implement Check()
}
extern "C"
JNIEXPORT jstring JNICALL
Java_com_umrani_tool_view_main_LoginActivity_loginURL(JNIEnv *env, jobject thiz) {
    // TODO: implement loginURL()
}
extern "C"
JNIEXPORT jstring JNICALL
Java_com_umrani_tool_view_main_BallPoolFloatingActivity_Icon(JNIEnv *env, jobject thiz) {
    // TODO: implement Icon()
}
extern "C"
JNIEXPORT void JNICALL
Java_com_umrani_tool_view_main_BallPoolFloatingActivity_stringFromJNI(JNIEnv *env, jobject thiz) {
